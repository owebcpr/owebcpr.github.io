...
const SAFETY_QUIZ = [
    {
        text: "Що робити, якщо незнайомець у соцмережі пропонує тобі «легкий заробіток» під час війни?",
    ...
    {
        text: "Якщо тобі в Telegram пишуть із пропозицією «підпалити авто за гроші» — це...",
        options: ["Звичайна робота", "Диверсія та злочин", "Розвага", "Спосіб допомогти армії"],
        correct: 1
    },
    {
    ...
    {
        text: "Чому російські спецслужби вербують українських дітей?",
        options: [
            "Щоб допомогти їм заробити",
            "Щоб використати їх для диверсій проти України",
            "Щоб подарувати їм нові телефони",
            "Щоб навчити їх програмування"
        ],
        correct: 1
    },
    {
        text: "Яка відповідальність загрожує підлітку за виконання завдання вербувальника?",
        options: [
            "Ніякої, бо він неповнолітній",
            "Позбавлення волі до 12 років",
            "Лише штраф",
            "Заборона користуватися інтернетом"
        ],
        correct: 1
    },
    {
        text: "Куди слід звернутися, якщо ти або твій друг отримали пропозицію від вербувальників?",
        options: [
            "До поліції (102) або на гарячу лінію 0 800 500 225",
            "До вербувальника, щоб домовитися",
            "Нікуди, це небезпечно",
            "До соцмереж, щоб поділитися"
        ],
        correct: 0
    }
];
